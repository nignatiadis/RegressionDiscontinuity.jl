...
Base.@propagate_inbounds function Base.getindex(ZsR::AbstractRunningVariable, i::AbstractArray)
...
function fit(::Type{Histogram{T}}, ZsR::AbstractRunningVariable; nbins=StatsBase.sturges(length(ZsR))) where {T}
